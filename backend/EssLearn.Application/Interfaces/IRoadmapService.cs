...
public interface IRoadmapService
{
    ...
    Task<RoadmapListItemDto?> UpdateAsync(int id, UpdateRoadmapDto dto);
    Task DeleteAsync(int id);
    Task<RoadmapNodeDto> AddNodeAsync(int roadmapId, CreateRoadmapNodeDto dto);
    Task<RoadmapNodeDto> AddPlaylistToRoadmapAsync(int roadmapId, AddPlaylistToRoadmapDto dto);
